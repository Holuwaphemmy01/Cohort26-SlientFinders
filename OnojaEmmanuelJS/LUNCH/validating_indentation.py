...
#print('A')
#print('Great Job!')
#print('Take a break from studying')116 Control Statements and Program Development
...
#Suppose you accidentally aligned the second print statement under the i in the if keyword. What kind of error would that be? Would you expect tabnanny to flag that as an
#error?
